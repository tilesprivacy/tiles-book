...
To begin with, we are collaborating with the [Darkshapes](https://darkshapes.org) team to support the [MIR](https://huggingface.co/darkshapes/MIR_) (Machine Intelligence Resource) model naming scheme in our FROM directive while maintaining full backward compatibility with the Ollama implementation. For model layering, we will use the open source implementation from Hugging Face in [xet-core](https://github.com/huggingface/xet-core).
